const { Card, Button, Pagination, Accordion, FormControl, Carousel, Image, Form } = require('react-bootstrap');
import axios from 'axios';
import { useState } from 'react';
import validator from 'validator';
import ModalContainer from './ModalContainer';

const TourList = ({ list = [], page, countPage }) => {
      ...
      {tourList.length === 0 ? (
        ...
        <>
          {tourList.map((tour, index) => {
            return (
              <Accordion defaultActiveKey={'0'} key={tour.id}>
                <Card border='primary'>
